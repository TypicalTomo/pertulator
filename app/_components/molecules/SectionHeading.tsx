...
const SectionHeading = ({ title, align = 'left', visuallyHidden = false }: Props) => {
  return (
    <div
      className={twMerge(
    ...
    >
      <h2
        className={twMerge(
          'relative bg-background font-heading text-2xl font-semibold text-foreground lg:text-4xl',
